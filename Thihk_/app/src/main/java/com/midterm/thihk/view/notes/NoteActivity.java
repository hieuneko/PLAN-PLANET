package com.midterm.thihk.view.notes;
...
import com.midterm.thihk.adapter.AdapterReminders;
import com.midterm.thihk.database.AppDatabase;
import com.midterm.thihk.database.RoomDAO;
...
public class NoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        appDatabase = AppDatabase.geAppdatabase(NoteActivity.this);
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(NoteActivity.this);
    ...
    public void addReminder(){
            ...
            public void onClick(View v) {
                DatePickerDialog dialog = new DatePickerDialog(NoteActivity.this, new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker view, final int year, final int month, final int dayOfMonth) {
                        ...
                        TimePickerDialog time = new TimePickerDialog(NoteActivity.this, new TimePickerDialog.OnTimeSetListener() {
                            @Override
                            public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                                ...
                                if(newDate.getTimeInMillis()-tem.getTimeInMillis()>0)
                                    ...
                                    Toast.makeText(NoteActivity.this,"Invalid time",Toast.LENGTH_SHORT).show();
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(NoteActivity.this,NotifierAlarm.class);
                ...
                PendingIntent intent1 = PendingIntent.getBroadcast(NoteActivity.this,reminders.getId(),intent,PendingIntent.FLAG_UPDATE_CURRENT);
                AlarmManager alarmManager = (AlarmManager)getSystemService(ALARM_SERVICE);
                alarmManager.setExact(AlarmManager.RTC_WAKEUP,calendar.getTimeInMillis(),intent1);

                Toast.makeText(NoteActivity.this,"Inserted Successfully",Toast.LENGTH_SHORT).show();
                setItemsInRecyclerView();
    ...
    ItemTouchHelper.SimpleCallback itemTouchHelperCallback = new ItemTouchHelper.SimpleCallback(0,ItemTouchHelper.LEFT) {
        ...
        public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
            RoomDAO dao = appDatabase.getRoomDAO();
            temp = dao.orderThetable();
            Reminders re = temp.get(viewHolder.getAdapterPosition());
            dao.Delete(re);
            setItemsInRecyclerView();
        }
    };
